...
const ServerError = require('../helprs/server_error')
...
describe('Login Router', () => {
  ...
  test('Should return 401 when invalid creadentials are provided', async () => {
    const { sut, authUseCaseSpy } = makeSet()
  ...
  test('Should return 200 when invalid creadentials are provided', async () => {
    const { sut, authUseCaseSpy } = makeSet()
    const httpRequest = {
      body: {
        email: 'invalid_email@mail.com',
